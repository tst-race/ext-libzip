...
def get_cli_arguments():
    ...
    parser = builder.get_arg_parser("libzip", "1.8.0", 1, __file__)
...
if __name__ == "__main__":
    ...
    builder.fetch_source(
        args=args,
        source=f"https://github.com/nih-at/libzip/archive/refs/tags/v{args.version}.tar.gz",
        extract="tar.gz",
    )

    source_dir = os.path.join(args.source_dir, f"libzip-{args.version}")
